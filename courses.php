...
<nav class="navbar" >
            <ul class="edu_links" id="sidebar">
                ...
                <li class="edu_list"><a href="search_course.php" class="edu_anchar">Search</a></li>
            ...
            <ul class="edu_links">
                ...
                <li class="hideOnMobile" class="edu_list"><a href="search_course.php" class="edu_anchar" id="search_btn">Search</a></li>
...
<main>
    <section class="contentSection" id="courses">
        <div class="container">
            <div class="cards">
                <?php
                if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '    <a href="' . htmlspecialchars($row['link']) . '" target="_blank">Explore</a>';
                        echo '</div>';
                    }
                } else {
